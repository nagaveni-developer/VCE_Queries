        ...
        <div id="content">
		    ...
		    <div id="button-block">
                    <form action="all.php" method="post" enctype="multipart/form-data" >
                        ...
                        <br>
                         <br>
                     <div class="buttons"> <input name="submit" type="submit" value="Display All" class="up-in" ></div>
                         </div><br>
                    </form>
                     <form action="<?php echo htmlspecialchars( $_SERVER["PHP_SELF"] ); ?>" method="post" enctype="multipart/form-data" >
                     <div class="buttons" ><input name="unanswered" type="submit" value="Unanswered" class="up-in" ></div>
            ...
            <div class="pop" id="ta">
                <h1 style="color:white"><b style="font-size: 1.5em; margin: -60px auto 10px; display: block;">:(</b>Sorry, Your search didn't match any documents.</h1>
            </div>
            <div class="pop" id="tb">
                <center><h1 style="color:white"><b style="font-size: 1.5em; margin: -60px auto 10px; display: block;">:)</b>Thank You For Your Answer.</h1></center>
            </div>
            <?php

                if(isset($_POST["unanswered"])) {
                    function valid($data){
                        $data = trim(stripslashes(htmlspecialchars($data)));
                        return $data;
                    }
                    ...
                    if($text != NULL){
                        ...
                        $words = explode(" ",$text);
                        $format = "SELECT * FROM `quans` WHERE answer is NULL";
                        $query = "";
                        if($query){
            ...
            ?>
                ...
                <center>
                    <div class='open' style='height: auto; margin: 60px auto -135px;'>
                        ...
                        <div id='topic'>
                            <h2 id='topic-head' style="font-weight: normal; border:none; font-size: 22px;">Showing list of all Unanswered Questions posted till now  :</h2>
                        </div>
                            ...
                            <div class="answer">
                                <?php
                                    if($row["answer"]){
                                        ...
                                        echo $row["answer"]."<br><small>Answered By: ";
                                        $all_answered= explode("@",$row["answeredby"]);
                                        foreach ($all_answered as $each) {
                                          echo"<a href='./profile_all.php?each=$each'>";echo "@".$each."</small>";echo "</a>";
                                        }
                                    }
                                    else{
                                        $nul=1;
                                ...
                                ?>
				     <!-- <div class="like_button"> <input type="sumit"><button >like</button></div> -->
