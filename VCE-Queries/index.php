        ...
        <div id="content">
           ...
           <div class="home_row">
			     ...
			     <h3 style="color:#F5F294;"><b>Ask</b></h3>
                     <p style="color:black;"><b>Do you have lots of questions in your mind. <br>Don’t know whom to ask. <br>Even Google didn’t give you exact results.<br> waiting for someone to clarify your doubts.<br> Then why late, post your queries in this forum.
					</b></p>
                    </center>
		      </div>
                 </div>
                 <div class="home_column">
			       ...
			       <h3 style="color:#F5F294;"><b>Clarify</b></h3>
                       <p style="color:black;"><b>Once you post your query, within minutes <br>your query will be answered.<br> And we help you move forward in your path. <br>Entire VCE is with you.
			       </b></p><br>
                      </center>
                        </div>
                </div>
		 ...
		 <div class="card">
			 ...
			 <h3 style="color:#F5F294;"><b>Explore</b></h3>
                     <p style="color:black;"><b>Posted query, got clarified then what next start exploring more. We are here to help in getting queries solved.
			     </b></p><br><br>
                 </center>
		 </div>
                 </div>
