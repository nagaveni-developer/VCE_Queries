            ...
            <?php
                ...
                if(isset($_POST["submit"])) {
                    ...
                    if($text != NULL){
                        ...
                        $words = explode(" ",$text);
                        $format = "SELECT * FROM `quans` ORDER by id DESC";
                        $query = "";
                        if($query){
            ...
            ?>
                ...
                <center>
                    <div class='open' style='height: auto; margin: 60px auto -135px;'>
                        ...
                        <div id='topic'>
                            <h2 id='topic-head' style="font-weight: normal; border:none; font-size: 22px;">Showing list of all Questions posted till now  :</h2>
                        </div>
