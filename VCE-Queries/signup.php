            ...
            <div id="sf">
                <center>
                    ...
                    <form action="otp_generate.php" method="post" enctype="multipart/form-data">
                        ...
                        <input name="year" id="year" type="text" title="If student, enter year of study." placeholder="enter year" >
			            <input name="branch" id="branch" type="text" title="Enter your branch." placeholder="Enter your branch" required>
